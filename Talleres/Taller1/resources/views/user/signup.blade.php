    ...
    <div class="d-flex justify-content-center h-100">
        <div class="user_card_signup">
            ...
            <div class="d-flex justify-content-center form_container">
                <form action="{{ route('user.signupPost') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-center mt-3 login_container">
                        <button type="submit" name="button" class="btn login_btn">SignUp</input>
                    </div>
                </form>
            </div>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-center links">
                    Already have an account? <a class="nav-link active" href="{{ route('user.login') }}">Log In</a>
                </div>
            </div>
        </div>
    </div>
